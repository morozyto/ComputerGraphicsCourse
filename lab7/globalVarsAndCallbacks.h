...
#ifdef USE_LESS_POINTS
int count_of_levels = 15;
int count_of_vertexes_in_circle = 15;
#else
int count_of_levels = 30;
int count_of_vertexes_in_circle = 30;
#endif
...
void GLFWInit() {
    ...
    window = glfwCreateWindow(1000, 1000, "Laba7", NULL, NULL);
    if (!window) {
        glfwTerminate();
    }
